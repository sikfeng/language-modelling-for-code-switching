...
logging.info("  CS accuracy: {0:.2f}".format(100 * validation_stats["cs_correct"] / validation_stats["cs_total"]))
...
logging.info("  CS accuracy: {0:.2f}".format(100 * testing_stats["cs_correct"] / testing_stats["cs_total"]))

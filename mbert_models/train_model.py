...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(f"models/{args.model_output}.log", mode='w'),
...
if args.model_type:
    model_lib = importlib.import_module(args.model_type)
    model = getattr(model_lib, "BertModelForCSModelling").from_pretrained("bert-base-multilingual-cased")
else:
...
for epoch_i in range(0, epochs):
    ...
    for step, batch in enumerate(train_data):
      ...
      if step % 10000 == 0 and (step != 0 or epoch_i == 0):
        ...
        logging.info("  CS accuracy: {0:.2f}, ZH accuracy: {1:.2f}, EN accuracy: {2:.2f}".format(100 * validation_stats["cs_correct"] / validation_stats["cs_total"], 100 * validation_stats["zh_correct"] / validation_stats["zh_total"], 100 * validation_stats["en_correct"] / validation_stats["en_total"]))
        ...
        logging.info("  CS accuracy: {0:.2f}, ZH accuracy: {1:.2f}, EN accuracy: {2:.2f}".format(100 * testing_stats["cs_correct"] / testing_stats["cs_total"], 100 * testing_stats["zh_correct"] / testing_stats["zh_total"], 100 * testing_stats["en_correct"] / testing_stats["en_total"]))

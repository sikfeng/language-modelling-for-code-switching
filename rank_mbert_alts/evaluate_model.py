...
val_scores = [x.tolist() for x in  val_scores]
test_scores = [x.tolist() for x in  test_scores]

json.dump(val_scores, open("val_scores.txt", 'w'), indent=2)
logging.info("Saved validation scores to val_scores.txt")
json.dump(test_scores, open("test_scores.txt", 'w'), indent=2)

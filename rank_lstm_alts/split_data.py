...
sents_f = json.load(open("alternate_sents_seame_filtered.json", 'r'))
...
json.dump(train_data, open("alternate_sents_seame_train_filtered.json", 'w'), indent=2, ensure_ascii=False)
json.dump(val_data, open("alternate_sents_seame_val_filtered.json", 'w'), indent=2, ensure_ascii=False)
json.dump(test_data, open("alternate_sents_seame_test_filtered.json", 'w'), indent=2, ensure_ascii=False)
